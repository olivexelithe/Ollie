...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        roster_worksheet_names=_csv_to_strings(
            os.getenv("ROSTER_WORKSHEET_NAMES", os.getenv("GOOGLE_WORKSHEET_NAMES", "PvP Roster"))
        ),
        roster_range=os.getenv("ROSTER_RANGE", os.getenv("GOOGLE_WORKSHEET_RANGE", "B1:F32")),
